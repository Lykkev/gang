...
class setupCommand extends Command {
  constructor(...args) {
    super(...args, {
      ...
      description: "Configura el bot o ve la configuración. \n **__Puedes usar para el mensaje de bienvenida o despedida:__** \n {member} para el nick del miembro \n {membercount} para el numero de miembros en el servidor \n {servername} para el nombre del servidor",
      allowdisable: false,
      cooldown: 3,
    });
  }
