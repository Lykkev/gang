...
module.exports = bot => {
  ...
  bot.on("guildBanAdd", async (guild, user) => {
    ...
    const embed = {
      ...
      author: {
        name: `${bot.tag(user, true)} fue prohibido por ${bot.tag(banner, true)}.`,
  ...
  bot.on("guildBanRemove", async (guild, user) => {
    ...
    const embed = {
      ...
      author: {
        name: `${bot.tag(user, true)} fue desbaneado por ${bot.tag(banner, true)}.`,
        icon_url: user.avatarURL,
      },
    };
    // Sends the embed
  ...
  bot.on("guildKick", (guild, reason, user, member) => trySend(guild, "guildKick", {
    ...
    color: bot.embed.color("error"),
    author: {
      name: `${bot.tag(user, true)} expulsado ${bot.tag(member, true)}.`,
      icon_url: user.avatarURL,
    },
  }));
};
